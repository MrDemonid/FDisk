#ifndef FDISK_WIN_MAIN_H
#define FDISK_WIN_MAIN_H
...
#define FD_NAME _T("Free FDISK")

#define VERSION  _T("1.0.0 Win")
#define COPYLEFT _T("1998 - 2025")
...
/*
/////////////////////////////////////////////////////////////////////////////
//  Единая точка выхода из программы (замена exit())
/////////////////////////////////////////////////////////////////////////////
*/
void halt(int code);
...
MEXTERN TCHAR filename[256];
MEXTERN TCHAR path[256];
...
#define A2T(str) a2t(str)
inline const wchar_t* a2t(char* s)
{
    static wchar_t buf[4096];
    if (!s)
        return L"";
    MultiByteToWideChar(CP_ACP, 0, s, -1, buf, _countof(buf)); // TODO: заменить CP_ACP на выбранный пользователем язык.
    return buf;
}
#else
#define A2T(str) (str)
